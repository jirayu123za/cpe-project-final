...
\begin{plan}{6}{2024}{10}{2025}
    ...
    \planitem{6}{2024}{7}{2024}{สํารวจความต้องการของผู้ใช้}
...
\section{\ifenglish Roles and responsibilities\else บทบาทและความรับผิดชอบ\fi}
    \begin{itemize}
        ...
        ติดต่อผู้ใช้ (Frontend Development) โดยรับผิดชอบออกแบบ UI ของแพลตฟอร์ม ประสบการณ์
        ผู้ใช้ และการพัฒนาฟังก์ชันต่างๆ ของฝั่งอาจารย์
        ...
        ติดต่อผู้ใช้ (Frontend Development) โดยรับผิดชอบออกแบบ UI ของแพลตฟอร์ม ประสบการณ์
        ผู้ใช้ และการพัฒนาฟังก์ชันต่างๆ ของฝั่งนักศึกษา
    \end{itemize}
...
\fi}
    ...
    การลดภาระงานที่ซํ้าซาก ปรับเปลี่ยนอยู่ตลอดเวลาและเพิ่มประสิทธิภาพในการทำงานสามารถช่วยลดความเครียดที่เกิดจากงานที่มี
    ความซับซ้อน
    ...
    ภาควิชาวิศวกรรมคอมพิวเตอร์ คณะวิศวกรรมศาสตร์ มหาวิทยาลัยเชียงใหม่ ซึ่งช่วยป้องกันการเข้าถึงที่ไม่
    ได้รับอนุญาต

    \qquad เนื่องจากระบบนี้เกี่ยวข้องกับการรวบรวมข้อมูล การใช้ข้อมูล การเปิดเผยข้อมูล และการรักษาข้อมูล
    ส่วนบุคคลของนักศึกษาและอาจารย์ของมหาวิทยาลัยเชียงใหม่ จึงต้องปฏิบัติตามตามนโยบายคุ้มครองข้อมูล
